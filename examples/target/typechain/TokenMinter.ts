...
export interface TokenMinterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwnership"
...
export interface TokenMinter extends BaseContract {
  connect(runner?: ContractRunner | null): TokenMinter;
