...
export interface MockMintBurnTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface MockMintBurnToken extends BaseContract {
  connect(runner?: ContractRunner | null): MockMintBurnToken;
  waitForDeployment(): Promise<this>;

  interface: MockMintBurnTokenInterface;
