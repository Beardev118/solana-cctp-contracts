...
export interface Ownable2StepTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_SCRIPT"
      | "IS_TEST"
      | "failed"
      | "setUp"
      | "testAcceptOwnership_onlyNewOwner"
      | "testTransferOwnership_onlyOwner"
      | "vm"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testAcceptOwnership_onlyNewOwner",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testTransferOwnership_onlyOwner",
    values: [AddressLike]
  ): string;
...
export interface Ownable2StepTest extends BaseContract {
  connect(runner?: ContractRunner | null): Ownable2StepTest;
  waitForDeployment(): Promise<this>;

  interface: Ownable2StepTestInterface;
  ...
  testAcceptOwnership_onlyNewOwner: TypedContractMethod<
    [],
    [void],
    "nonpayable"
  >;

  testTransferOwnership_onlyOwner: TypedContractMethod<
    [_wrongOwner: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "testAcceptOwnership_onlyNewOwner"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "testTransferOwnership_onlyOwner"
  ): TypedContractMethod<[_wrongOwner: AddressLike], [void], "nonpayable">;
